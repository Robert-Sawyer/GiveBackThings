...
<div class="dashboardPageContainer" style="background-size: 100%; background-image: url(/media/images/P9046627)">
    <div class="pageTitle">
        <h2 style="color: white;">LISTA ZAUFANYCH INSTYTUCJI</h2>
    </div>
                ...
                <li>
                    <table style="color: black;">
                        <tr>
                            ...
                            <td>
                                <form:form modelAttribute="deleteInstitution" method="post">
                                    <input type="hidden" value="${inst.id}" name="institutionId">
                                    <input type="submit" value="Usuń instytucję" name="delete">
                                </form:form>
                            </td>
                        </tr>
                    </table>
