...
<head>
    ...
    <title>Przekaż dar. Krok 1</title>
...
<section class="form--steps">
    ...
    <div class="form--steps-container">
        ...
        <form:form method="post" modelAttribute="addGift">
            ...
            <div data-step="1" class="active">
                <h3>Zaznacz co chcesz oddać:</h3>
                    ...
                    <label>
                        <form:checkbox path="category" value="clothes-to-use"/>
                    ...
                    <label>
                        <form:checkbox path="category" value="clothes-useless"/>
                        <span class="checkbox"></span>
                    ...
                    <label>
                        <form:checkbox path="category" value="toys"/>
                        <span class="checkbox"></span>
                        <span class="description">zabawki</span>
                    </label>

                    <label>
                        <form:checkbox path="category" value="books"/>
                        <span class="checkbox"></span>
                        <span class="description">książki</span>
                    </label>

                    <label>
                        <form:checkbox path="category" value="other"/>
                        <span class="checkbox"></span>
